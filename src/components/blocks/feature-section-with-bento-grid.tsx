...
export const SkeletonTwo = () => {
  ...
  useEffect(() => {
    if (isMounted) {
      const firstRowRotations = images.map(() => Math.random() * 20 - 10);
      const secondRowRotations = images.map(() => Math.random() * 20 - 10);
      setRotations([...firstRowRotations, ...secondRowRotations]);
    }
  }, [isMounted]);
